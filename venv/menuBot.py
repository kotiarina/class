...
m_fun = Menu("Развлечения", buttons=["Прислать собаку", "Прислать цитату", "Прислать гороскоп",  "Прислать анекдот", "Прислать фильм", "Прислать курсы", "Угадай кто?", "Выход"], parent=m_main, module="fun")
