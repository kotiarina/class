...
m_fun = Menu("Развлечения", buttons=["Прислать собаку", "Прислать цитату", "Прислать гороскоп",  "Прислать анекдот", "Прислать фильм", "Прислать курсы", "Угадай кто?",'Прислать снимок Nasa','МКС online', "Выход"], parent=m_main, module="fun")
