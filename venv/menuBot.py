...
m_games = Menu("Игры", buttons=["Игра КНБ", "Игра КНБ-MP", "Игра в 21",'Калькулятор', "Выход"], parent=m_main)
...
m_DZ = Menu("ДЗ", buttons=["Факториал", "Синус", "Косинус", "Тангенс", "Возраст", "Имя", "Выход"], parent=m_main, module="DZ")

m_fun = Menu("Развлечения", buttons=["Прислать собаку", "Прислать цитату", "Прислать гороскоп",  "Прислать анекдот", "Прислать фильм", "Прислать курсы", "Угадай кто?",'Прислать карту звёздного неба','МКС online', "Выход"], parent=m_main, module="fun")

# m_fun = Menu("Развлечения", buttons=[["Прислать собаку", "Прислать лису"], ["Прислать гороскоп", "Прислать фильм"], ["Выход"]], parent=m_main)
